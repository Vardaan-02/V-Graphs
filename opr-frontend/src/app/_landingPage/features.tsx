...
const Features = () => {
  ...
  return (
    <section id="features" className="py-32 bg-gradient-to-b from-black to-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          ...
          <h2 className="text-4xl md:text-6xl font-bold text-white mb-6">
            ...
            <span className="block bg-gradient-to-r from-cyan-600 to-white bg-clip-text text-transparent">
              automate anything
            </span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <Card 
              key={index} 
              className="group bg-neutral-200 backdrop-blur-sm border border-black/10 hover:border-cyan-500/20 hover:shadow-2xl transition-all duration-500 rounded-2xl overflow-hidden"
            >
